...
const translations = {
  en: {
    ...
    // Hero Section
    heroTitle: "Professional Painting Solutions in Qatar",
    heroSubtitle:
      "Transform your space with premium painting services from Paint Tech Contracting WLL",
  ...
  ar: {
    ...
    heroSubtitle:
      "حول مساحتك مع خدمات الطلاء المتميزة من شركة بينت تك للمقاولات ذ.م.م",
